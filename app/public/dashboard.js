...
function showNewAppointmentForm(dateStr, defaultHour = '') {
    ...
    // Función para crear fecha sin desfase por zona horaria
    ...
    setTimeout(() => {
        ...
        didOpen: () => {
            ...
            // Prevenir propagación de eventos que puedan cerrar el modal
            if (popup) {
                popup.style.pointerEvents = 'auto';
            }
            
            // Inicializar Select2 con un delay más largo y sin bloquear el hilo principal
            setTimeout(() => {
                try {
                    // Cliente
